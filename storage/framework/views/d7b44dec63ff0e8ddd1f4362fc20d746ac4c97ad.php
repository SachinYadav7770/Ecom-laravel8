    ...
    <div class="row">
        ...
        <div class="jumbotron col-sm-12">
            <div class="container-fluid">
                <div class="centered">
                <form action="place_order" method="post"> <?php echo csrf_field(); ?>
                    <div class="form-row">
                        <div class="col">
...
<?php echo $__env->make('layout/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH P:\wamp\www\eCommerce\resources\views/ordernow.blade.php ENDPATH**/ ?>